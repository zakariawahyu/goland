...
and ps.kode_barang = br.kode_barang and ps.kode_layanan = ly.kode_layanan and username_laundry='$nama' and status_pesanan='Selesai' order by kode_pesanan desc";
            ...
            while ($row = mysqli_fetch_array($hasil2)) {
              ...
              <tr>
                ...
                <td><button type="submit" class="btn btn-default" name="update"><a href="print.php?id=<?php echo $row['kode_pesanan']; ?>">Cetak Nota</a></button></td>
              </tr>
              <?php
            }
